...
class Emprestimo:
    def __init__(self, value, taxa, time):
        self.value = value
        self.taxa = taxa
        self.time = time

    def calcula_valor_final(self):
        valor_final = (self.value + (self.value * self.taxa * self.time))
        return f'Valor final pago ao banco: {valor_final}'
...
valor_final = Emprestimo(valor_emprestimo, taxa_banco, tempo)
print(valor_final.calcula_valor_final())